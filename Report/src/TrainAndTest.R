...
measure_performance(rf_pred_prob$YES)
measure_performance(treebag_pred_prob$YES)
measure_performance(rpart_pred_prob$YES)
measure_performance(nb_pred_prob$YES)
measure_performance(knn_pred_prob$YES)
